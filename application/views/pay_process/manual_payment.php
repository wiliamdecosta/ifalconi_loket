            	 ...
            	 <div class="panel panel-info">
            	      ...
            	      <div class="panel-body">
                          ...
                          <div class="col-xs-12">
                              ...
                              <input type="hidden" class="form-control" id="form_p_user_loket_id" value="<?php echo $userdata['p_user_loket_id']; ?>">
                              <input type="hidden" class="form-control" id="form_p_bank_branch_id"  value="<?php echo $userdata['p_bank_branch_id']; ?>">
